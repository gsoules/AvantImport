...
class AvantImport_ColumnMap_Tag extends AvantImport_ColumnMap
{
    const TAG_DELIMITER_OPTION_NAME = 'avant_import_tag_delimiter';
    ...
    public function __construct($columnName, $tagDelimiter = null)
    {
        ...
        $this->_type = AvantImport_ColumnMap::TYPE_TAG;
