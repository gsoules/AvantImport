<fieldset id="avantimport-item-metadata">
    <h2><?php echo __('AvantImport'); ?></h2>
    <div class="field">
        ...
        <div class="inputs five columns omega">
            <label class="order-by-filename">
                <?php
                    echo $this->formCheckbox('custom[avantimport][orderByFilename]', null, array(
    ...
    <div class="field">
        ...
        <div class="inputs five columns omega">
            <label class="mix-images">
                <?php
                    echo $this->formCheckbox('custom[avantimport][mixImages]', null, array(
